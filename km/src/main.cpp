...
namespace driver {
	...
	NTSTATUS device_control(PDEVICE_OBJECT device_object, PIRP irp) {
		...
		// Find out which code was passed through.
...
NTSTATUS driver_main(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path) {
	...
	RtlInitUnicodeString(&device_name, L"\\Device\\asdf");
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\asdf");
...
NTSTATUS DriverEntry() {
	...
	RtlInitUnicodeString(&driver_name, L"\\Driver\\asdf");
